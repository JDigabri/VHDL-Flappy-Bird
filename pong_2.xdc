...
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports { speed1 }];
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports { speed2 }];
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports { speed3 }];
set_property -dict {PACKAGE_PIN R15 IOSTANDARD LVCMOS33} [get_ports { speed4 }];
